...
{
    public partial class frmZectRaws : Form
    {
        ...
        public frmZectRaws(string _itemCode, string _itemDesc)
        {
            InitializeComponent();
            itemCode = _itemCode;
            itemDesc = _itemDesc;
        ...
        private void frmZectRaws_Load(object sender, EventArgs e)
        {
        ...
        public void getCurrentRaws()
        {
            try
            {
                string itemRaws = Client.getCatalystRaws(itemCode);
        ...
        private void RibtnRemove_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string deleted = Client.removeCatalystLink(itemCode + "|" + rmCode);
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                dtRaw.Rows.Clear();
                string itemRaws = Client.getZectRMs();
                if (itemRaws != string.Empty)
                {
                    switch (itemRaws.Split('*')[0])
                    {
        ...
        private void RibtnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string added = Client.addCatalystLink(itemCode + "|" + rmCode + "|" + rmDesc + "|" + GlobalVars.userName);
