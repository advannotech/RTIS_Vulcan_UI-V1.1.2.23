...
{
    public partial class frmCanningRaws : Form
    {
        ...
        public frmCanningRaws(string _itemCode, string _itemDesc)
        {
            InitializeComponent();
            itemCode = _itemCode;
            itemDesc = _itemDesc;
        ...
        private void frmCanningRaws_Load(object sender, EventArgs e)
        {
        ...
        public void getCurrentRaws()
        {
            try
            {
                string itemRaws = Client.getCanningCatalystRaws(itemCode);
        ...
        private void RibtnRemove_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string deleted = Client.removeCanningLink(itemCode + "|" + rmCode);
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                dtRaw.Rows.Clear();
                string itemRaws = Client.getCanningRMs();
                if (itemRaws != string.Empty)
                {
                    switch (itemRaws.Split('*')[0])
                    {
        ...
        private void RibtnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string added = Client.addCanningRMLink(itemCode + "|" + itemDesc + "|" + rmCode + "|" + rmDesc + "|" + GlobalVars.userName);
