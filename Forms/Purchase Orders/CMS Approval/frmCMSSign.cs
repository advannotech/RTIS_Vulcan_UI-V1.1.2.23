...
{
    public partial class frmCMSSign : Form
    {
        frmApproveCMS m_parent; // give access to calling form
        public frmCMSSign(frmApproveCMS parent, wgssSTU.IUsbDevice usbDevice)
        {
            m_parent = parent;
            ...
            Size clientSize = new Size((int) (m_capability.tabletMaxX / 2540F * 96F),
            ...
            bool useColor = false;
            if ((encodingFlag & (wgssSTU.encodingFlag.EncodingFlag_16bit | wgssSTU.encodingFlag.EncodingFlag_24bit)) !=
                0)
            {
            ...
            // format.
            {
                ...
                m_bitmapData = (byte[]) protocolHelper.resizeAndFlatten(stream.ToArray(), 0, 0, (uint) m_bitmap.Width,
                    (uint) m_bitmap.Height, m_capability.screenWidth, m_capability.screenHeight, (byte) m_encodingMode,
            ...
            m_tablet.onGetReportException +=
                new wgssSTU.ITabletEvents2_onGetReportExceptionEventHandler(onGetReportException);
        ...
        private List<wgssSTU.IPenData>
            m_penData; // Array of data being stored. This can be subsequently used as desired.
        ...
        private PointF tabletToClient(wgssSTU.IPenData penData)
        {
            ...
            return new PointF((float) penData.x * this.ClientSize.Width / m_capability.tabletMaxX,
                (float) penData.y * this.ClientSize.Height / m_capability.tabletMaxY);
        }
        ...
        private Point tabletToScreen(wgssSTU.IPenData penData)
        {
            ...
            return Point.Round(new PointF((float) penData.x * m_capability.screenWidth / m_capability.tabletMaxX,
        ...
        private Point clientToScreen(Point pt)
        {
            ...
            return Point.Round(new PointF((float) pt.X * m_capability.screenWidth / this.ClientSize.Width,
                (float) pt.Y * m_capability.screenHeight / this.ClientSize.Height));
        }
        ...
        private void frmCMSSign_MouseClick(object sender, MouseEventArgs e)
        {
        ...
        private void frmCMSSign_Paint(object sender, PaintEventArgs e)
        {
            if (m_penData.Count != 0)
            {
        ...
        private void frmCMSSign_FormClosed(object sender, FormClosedEventArgs e)
        {
