...
{
    public partial class ucZectRawMaterials : UserControl
    {
        ...
        #endregion
        public ucZectRawMaterials()
        {
            InitializeComponent();
        }
        private void ucZectRawMaterials_Load(object sender, EventArgs e)
        {
            setupDataTable();
            refreshCatalysts();
        ...
        private void RibtnView_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                frmZectRaws zRaws = new frmZectRaws(itemCode, itemDesc);
                zRaws.ShowDialog();
            }
            catch (Exception ex)
            {
