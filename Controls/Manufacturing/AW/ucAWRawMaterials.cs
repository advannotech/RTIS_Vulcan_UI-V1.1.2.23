...
using RTIS_Vulcan_UI.Forms.AW;

namespace RTIS_Vulcan_UI.Controls.Manufacturing
{
    public partial class ucAWRawMaterials : UserControl
    {
        ...
        public ucAWRawMaterials()
        {
            InitializeComponent();
        }

        private void ucAWRawMaterials_Load(object sender, EventArgs e)
        {
            setupDataTable();
            refreshCatalysts();
        ...
        private void RibtnView_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                frmAWRaws awRaws = new frmAWRaws(itemCode, itemDesc);
                awRaws.ShowDialog();
            }
            catch (Exception ex)
            {
