...
{
    public partial class ucWhseAdmin : UserControl
    {
        ...
        private void ucWhseAdmin_Load(object sender, EventArgs e)
        {
            setUpDatatables();
            getProcesses();
        }
        ...
        public void getProcesses()
        {
            try
            {
                string processes = Client.getWhtProcs();
        ...
        private void gvWhses_CellValueChanged(object sender, DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs e)
        {
            try
            {
                ...
                if (view.UpdateCurrentRow())
                {
                    ...
                    string updated = Client.setWhseLookupEnabled(procName + "|" + whseID + "|" + whseSelected);
